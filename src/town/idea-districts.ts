...
const moved:Record<string,{idea:DistrictIdea;dx:number;dz:number}>={
  market:{idea:'market',dx:-11,dz:8},tavern:{idea:'market',dx:11,dz:8},
  forge:{idea:'workshop',dx:-11,dz:8},workshop:{idea:'workshop',dx:11,dz:8},
...
export function districtFocus(idea:Idea){
  const district=IDEA_DISTRICTS[idea as DistrictIdea];
  if(!district)return undefined;
  const castleProject=PLOTS.find(plot=>plot.id===district.hero&&plot.kind==='project');
  return castleProject?{x:castleProject.x,z:castleProject.z}:district;
}

export const DISTRICT_MILESTONES:Record<DistrictIdea,readonly [string,string][]>={
  market:[['Idle Outpost opens','A trading outpost opens within the castle walls, with its first stalls beyond them.'],['Merchant outpost','Banners and a larger trading post welcome arriving merchants.'],['Castle trade route','Idle Outpost becomes a trading hall as the market road reaches the castle.'],['Covered market','Covered stalls expand the outlying marketplace.'],['Merchant warehouses','A warehouse joins the outpost to store the growing trade.'],['Artisan bazaar','A second row of specialist stalls enlarges the same market.'],['Trade office','A permanent trade office serves the busy outpost.'],['Grand marketplace','A grand trading hall and entrance complete the Idle Outpost district.']],
  workshop:[['Sandship lands','Sandship descends near the castle while its first forge opens in the workshop yard.'],['Working yard','Better machinery and workshop supplies develop around Sandship.'],['Castle supply route','The machine yard grows and its supply road reaches Sandship at the castle.'],['Machine shop','A machine shop expands the outlying workshop yard.'],['Smelting house','A smelting house joins the workshop district.'],['Engineering hall','Engineers build a permanent hall beside Sandship.'],['Design office','A design office supports the growing machine yard.'],['Master foundry','A master foundry and formal entrance complete the workshop district.']],
  roads:[['Dwarven roadworks','A dwarven mining guild opens within the walls while surveyors mark the castle roads.'],['Connected roadworks','Developed roads link the dwarven works to the castle gate.'],['Paved supply route','Stone paving strengthens the connection to the dwarven works.'],['Tool yard','A tool yard expands the original roadworks camp.'],['Traveler lodge','A lodge welcomes travelers beside the roadworks.'],['Masons’ guild','The masons build a permanent guild at their original camp.'],['Route office','A route office coordinates the growing road network.'],['Transport hall','A transport hall and formal entrance complete the dwarven district.']],
  ...
  observatory:[['Wizard observatory','A small wizard observatory is built within the castle walls.'],['Improved telescope','A better lens improves the original observatory.'],['Castle observatory route','The observatory develops and a road connects it to the castle.'],['Lens workshop','A lens workshop opens in the outlying observatory district.'],['Astronomy school','An astronomy school opens beside the wizard tower.'],['Star library','A star library expands the observatory district.'],['Research hall','A research hall grows around the original tower.'],['Celestial academy','A celestial academy and formal entrance complete the observatory district.']],
};
